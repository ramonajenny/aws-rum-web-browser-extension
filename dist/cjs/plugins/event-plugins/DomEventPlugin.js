...
exports.DomEventPlugin = exports.DOM_EVENT_PLUGIN_ID = void 0;
var InternalPlugin_1 = require("../InternalPlugin");
var constant_1 = require("../utils/constant");
exports.DOM_EVENT_PLUGIN_ID = 'dom-event';
var defaultConfig = {
...
var DomEventPlugin = /** @class */ (function (_super) {
    ...
    function DomEventPlugin(config) {
        var _this = _super.call(this, exports.DOM_EVENT_PLUGIN_ID) || this;
        _this.enabled = false;
    ...
    DomEventPlugin.prototype.getEventListener = function (cssLocator) {
        ...
        return function (event) {
            ...
            if ((_a = _this.context) === null || _a === void 0 ? void 0 : _a.record) {
                _this.context.record(constant_1.DOM_EVENT_TYPE, eventData);
            }
        };
    };
