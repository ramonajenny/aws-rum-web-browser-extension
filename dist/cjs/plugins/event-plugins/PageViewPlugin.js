...
exports.PageViewPlugin = exports.PAGE_EVENT_PLUGIN_ID = void 0;
var Orchestration_1 = require("../../orchestration/Orchestration");
var MonkeyPatched_1 = require("../MonkeyPatched");
exports.PAGE_EVENT_PLUGIN_ID = 'page-view';
/**
...
var PageViewPlugin = /** @class */ (function (_super) {
    ...
    function PageViewPlugin() {
        var _this = _super.call(this, exports.PAGE_EVENT_PLUGIN_ID) || this;
    ...
    PageViewPlugin.prototype.createIdForCurrentPage = function () {
        ...
        switch (this.context.config.pageIdFormat) {
            case Orchestration_1.PageIdFormatEnum.PathAndHash:
                if (path && hash) {
                    return path + hash;
                }
                else if (path) {
                ...
                return '';
            case Orchestration_1.PageIdFormatEnum.Hash:
                return hash ? hash : '';
            case Orchestration_1.PageIdFormatEnum.Path:
            default:
                return path ? path : '';
        }
    };
